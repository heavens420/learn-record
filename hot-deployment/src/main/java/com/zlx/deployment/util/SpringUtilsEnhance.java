...
@Component
public class SpringUtilsEnhance implements BeanFactoryPostProcessor, ApplicationContextAware {
    ...
    public void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) throws BeansException {
        SpringUtilsEnhance.beanFactory = beanFactory;
    }

    @Override
    public void setApplicationContext(ApplicationContext applicationContext) {
        SpringUtilsEnhance.applicationContext = applicationContext;
    }
